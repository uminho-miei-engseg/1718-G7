...
def printUsage():
    print("Usage: python desofusca-app.py -s \"assinatura cega\" -RDash \"prDashComponents\"")
...
def parseArgs():
    if (len(sys.argv) == 5 and sys.argv[1] == '-s' and sys.argv[3] == '-RDash'):
        ...
        errorCode, signature = eccblind.unblindSignature(sys.argv[2], sys.argv[4], blindComponents)
